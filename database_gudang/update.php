...
<head>
    ...
    <title>Pembaharuan Data Produk - Gudang PT Mie Jaya</title>
...
<body>
    ...
    <div class="container">
        <h1 class="text-center">Pembaharuan Data Produk</h1>
            <?php
                include 'hubung.php';
                $kode_barang=$_GET['kode_barang'];
                $data=mysqli_query($hubung, "SELECT * FROM data_barang WHERE kode_barang='$kode_barang' ") 
                or die(mysqli_error($hubung));
                $baris=mysqli_fetch_array($data);
            ?>
        <div class="row justify-content-center">
            <div class="col-md-6">
                <form class="row-g-3" action="proses_update.php?kode_barang=<?php echo $kode_barang ?>" method="post">
